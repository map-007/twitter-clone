  ...
  <div>
    <div class="flex items-center flex-shrink-0 p-3 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          v-model="text"
          class="w-full py-1 px-2 h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text.white focus:ring-0 outline-0"
    ...
    <div class="p-4 pl-16" v-if="inputImageUrl">
      <img
        :src="inputImageUrl"
        alt=""
